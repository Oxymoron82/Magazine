...
export const columns: Column[] = [
  {
    ...
    descriptionShort: "Personal stories of change, identity, and becoming.",
    description:
  ...
  },
  {
    ...
    label: "WORK",
    title: "Work & Path",
    descriptionShort: "Careers, entrepreneurship and building something real.",
    description:
  ...
  },
  {
    ...
    descriptionShort: "Conversations with photographers, designers and makers.",
    description:
  ...
  },
  {
    ...
    descriptionShort: "Fashion and art editorials as visual language.",
    description:
  ...
  },
  {
    ...
    descriptionShort: "Stories of people outside the spotlight.",
    description:
  ...
  },
  {
    ...
    label: "INTIMACY",
    title: "Body & Intimacy",
    descriptionShort: "Conversations about body, sexuality and boundaries.",
    description:
  ...
  },
  {
    ...
    label: "VARIA",
    title: "Misc",
    descriptionShort: "Fragments, notes and short pieces.",
    description:
